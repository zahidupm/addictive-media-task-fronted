    ...
    return (
        <div className='mt-24'>
            <div className='w-full lg:px-8 px-4'>
                <img className='w-full h-96' src="https://elearningindustry.com/wp-content/uploads/2016/11/role-graphic-designer-elearning-team.jpg" alt="" />
            </div>
            <div className='-mt-72'>
      ...
      <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
        ...
        <p className="text-base text-gray-700 md:text-lg">
          This is our very good working team and I always wanted to grow my skills and our team very hard working.
        </p>
      </div>
